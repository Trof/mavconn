...
mavlink_local_position_ned_t currentpos;	///< current position
mavlink_attitude_t currentatt;	///< current attitude
mavlink_mission_item_t* wpl = NULL;	///< current waypoint list
		...
		const mavconn_mavlink_msg_container_t* container, void * user)
{
	...
	case MAVLINK_MSG_ID_LOCAL_POSITION_NED:
		mavlink_msg_local_position_ned_decode(msg, &currentpos);
 ...
 *
 */
void sendPosition(mavlink_local_position_ned_t* pos, mavlink_attitude_t* att)
{
	...
	mavlink_msg_local_position_ned_encode(systemid,compid,&msg,pos);
 ...
 *
 */
void calcPosition(mavlink_local_position_ned_t* nextpos, mavlink_attitude_t* nextatt)
{
	/* P-controller
...
int main (int argc, char ** argv)
{
	...
	mavlink_local_position_ned_t nextpos = currentpos;
